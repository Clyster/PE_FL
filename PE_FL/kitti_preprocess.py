...
args.val_h = 352
args.val_w = 1216
args.resume = '/home/ubuntu-user/Desktop/hzy/results/input=rgbd.criterion=l2.lr=0.001.bs=6.round=1.time=2024-06-19@21-23/checkpoint-9.pth.tar'
print(args)
args.rgb_lost = False
args.d_lost = False
...
def save_prediction(image, path):
    ...
    image = (image * 256).astype('uint16')   # 622 added
    # new_size = (375, 1242)
...
for user in range(1,21):
    ...
    with torch.no_grad():
        for idx, item in enumerate(dataloader):
            ...
            save_path = sparse_path.replace('/KITTI/','/KITTI3/')
            print(save_path)
